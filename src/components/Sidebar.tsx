...
const Sidebar: React.FC<SidebarProps> = ({ darkMode, toggleDarkMode, className, isMobileMenuOpen, setIsMobileMenuOpen }) => {
  ...
  return (
    <aside className={`bg-white dark:bg-gray-800 flex flex-col h-screen transition-all duration-300 ease-in-out fixed inset-y-0 left-0 z-50 w-64 lg:w-64 transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} lg:relative lg:translate-x-0 ${className}`}>
        ...
        <div className="flex-grow overflow-y-auto">
          <div className="p-6">
            ...
            <div className="flex items-center space-x-2 mb-8">
              ...
              <span className="text-xl font-bold dark:text-white">Buzzly</span>
            </div>
